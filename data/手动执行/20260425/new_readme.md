...
python 062_cyq_chips.py --start 20240101 --end 20240430 --window-days 50 --page-size 6000
```

## 注意事项

- 036~044 按股票循环，全量约需数小时，建议在非交易时段运行
- 062 cyq_chips 是按股票必填接口，补单日也会遍历全市场股票；默认按 50 个交易日窗口分页，兼顾 6000 行单次上限和同步速度
