"""
接口：top10_floatholders，可以通过数据工具调试和查看数据
描述：获取上市公司前十大流通股东数据
权限：需2000积分以上才可以调取，5000积分以上频次会更高
接口文档: https://tushare.pro/document/2?doc_id=62
本地文档: docs/tushare/tushare.pro/document/282bd.html
...
表名：050_top10_floatholders
迁移说明：tushare schema 中无此表，无需迁移
用法: python 050_top10_floatholders.py [--start YYYYMMDD] [--end YYYYMMDD] [--quarters N] [--page-size 6000]
"""
import argparse, sys
