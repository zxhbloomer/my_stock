...
TABLE         = "031_hsgt_top10"
DEFAULT_START = "20141117"  # 沪股通2014-11-17开通；深股通2016-12-05开通
...
FLOAT_COLS = ["close", "change", "amount", "net_amount", "buy", "sell"]
...
def normalize_hsgt_top10_df(df):
