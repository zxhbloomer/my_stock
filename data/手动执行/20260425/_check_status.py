...
SCRIPT_TABLE_MAP = [
    ...
    ("049_top10_holders.py", "049_top10_holders", "ann_date"),
    ("050_top10_floatholders.py", "050_top10_floatholders", "ann_date"),
    ("051_pledge_stat.py", "051_pledge_stat", "end_date"),
    ("058_stk_holdernumber.py", "058_stk_holdernumber", "ann_date"),
    ("060_report_rc.py", "060_report_rc", "report_date"),
