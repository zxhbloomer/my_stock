...
def make_net_value_figure(nav, metrics, start_date, end_date):
    ...
    fig.update_layout(
        ...
        title=dict(text=f"v4 BBI月度强弱轮动  回测区间：{start_date} ~ {end_date}", x=0.02, xanchor="left"),
...
def main():
    summary, nav, trades, scores, holdings = load_v4()
