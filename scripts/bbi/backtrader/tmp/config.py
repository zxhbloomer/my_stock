...
ATR_PERIOD     = 14
ATR_MULTIPLIER = 2.5   # stop = peak_close - ATR_MULTIPLIER * ATR(14)

OUTPUT_DIR     = Path(__file__).parent / "output"
STOCK_DATA_DIR = Path(__file__).parent.parent / "v2" / "output" / "stock_data"
KLINE_DATA_DIR = OUTPUT_DIR / "kline_data"

# tmp experiment: minimum hold days before exit signals are checked
MIN_HOLD_DAYS  = 5
# hard stop loss: exit immediately if loss exceeds this (regardless of hold period)
